...
function LayoutDashboard() {
  ...
  const [editSelectedImageUrl, setEditSelectedImageUrl] = useState(null);
  ...
  const handleEditClick = () => {
    editFileInputRef.current.click(); // Simula clic en input para editar imagen
  };
  ...
  const handleEditFileChange = async (e) => {
    ...
    if (file) {
      const imageUrl = await uploadImageToS3(file);
      setEditSelectedImageUrl(imageUrl); // Guardamos la nueva URL de la imagen
    }
  };
            ...
            <div className="bg-white p-5 rounded-lg w-1/2 max-h-[70vh] overflow-y-auto">
              ...
              >
                ...
                <div>
                  ...
                  {/* Vista previa de la imagen */}
                  {editSelectedImageUrl || editProduct.imageUrl ? (
                    <div
                      className="mt-4 border border-gray-300 rounded-lg"
                      style={{
                        width: "100%",
                    ...
                    >
                      <img
                        src={editSelectedImageUrl || editProduct.imageUrl}
                        alt="Vista previa"
                        style={{
                          maxWidth: "100%",
                          maxHeight: "100%",
